    ...
    return (
        <>
            <div className="index-2-header position-relative">
                ...
                <ImageSlider
                    image1="index-2-header-img-1.jpg"
                    image2="index-2-header-img-1.jpg"
                    image3="index-2-header-img-1.jpg"
                />
            </div>
            <div className="services">
                <div className="services-wrapper">
                    ...
                    <div className="service-section service-image">
                        <ServiceBox
                            index="1"
                            imagePath="service_thumbnail_img_1.jpg"
                            icon={
                                <svg
        ...
        0,0,0,6.689.3v12.932a5.986,5.986,0,0,0-2.068-.267,5.859,5.859,0,0,0-4.06,1.942l-.144.192a41.211,41.211,0,0,1-4.629,5.957,29.146,29.146,0,0,0-6.738-4.613l-1.277,2.715a26.461,26.461,0,0,1,5.824,3.954,5.943,5.943,0,0,1-3.27,1.6v3c5.348,0,11.555-9.341,12.553-10.9a2.854,2.854,0,0,1,3.809-.248v15.4c0,.005,0,.01,0,.016h0v4.529a4.547,4.547,0,0,0-5.6,2.105l2.639,1.425a1.584,1.584,0,0,1,2.136-.64,1.588,1.588,0,0,1,.821,1.458h.007v1.528h-.014a6.5,6.5,0,1,1-11.286-4.552l4.543-4.944-2.209-2.029-2.244,2.442-3.7-1.3-1,2.831,2.483.873-.092.1a9.445,9.445,0,0,0-2.346,4.844,6.767,6.767,0,0,1-4.517-2.552c-2.713-3.605-1.426-9.672-1.413-9.73l.181-.816-.6-.583c-2.711-2.646-4.045-5.487-3.966-8.444.145-5.37,4.857-9.561,4.9-9.6l.694-.6-.223-.892c-1-4.017-.347-6.673,1.952-7.892l-1.4-2.651c-2.42,1.284-4.953,4.128-3.654,10.412-1.524,1.546-5.109,5.742-5.264,11.122-.1,3.613,1.343,7.016,4.3,10.123-.315,2.065-.793,7.51,2.084,11.347a9.879,9.879,0,0,0,6.9,3.789,9.446,9.446,0,0,0,7.072,7.757,9.585,9.585,0,0,0,2.315.286,9.469,9.469,0,0,0,7.965-4.377,9.223,9.223,0,0,0,3.057,3.016,9.434,9.434,0,0,0,4.873,1.361,9.576,9.576,0,0,0,2.314-.286,9.44,9.44,0,0,0,7.072-7.754,9.887,9.887,0,0,0,6.931-3.792c2.877-3.837,2.4-9.282,2.084-11.347C1629.155,1285.166,1630.6,1281.763,1630.5,1278.15Zm-6.862-10.692-.02.023.019-.023Z"
                            ...
                            heading="Strategy"
                            para="Midst good shall them there gathered you together buy bearing over said void give deep fill fourth them the pod isn’t abundantly."
                        />

                        <ServiceBox
                            index="2"
                            imagePath="service_thumbnail_img_2.jpg"
                            icon={
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    data-name="Layer 1"
                            ...
                            para="Saw I lights fruit seasons us very fifth his image fill open. Two earth together, whales so brought all without, two cattle stars above."
                        />

                        <ServiceBox
                            index="3"
                            imagePath="service_thumbnail_img_3.jpg"
                            icon={
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    data-name="Layer 1"
                            ...
                            para="Evening give Lesser said is have heaven have multiply lights night life. You over for bring had whose created it grass image great."
                        />

                        <ServiceBox
                            index="4"
                            imagePath="service_thumbnail_img_4.jpg"
                            icon={
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    data-name="Layer 1"
                            ...
                            para="Midst good shall them there gathered you together jets bearing over said void give deep fill fourth them the pod isn’t abundantly living."
                        />

                        <ServiceBox
                            index="5"
                            imagePath="service_thumbnail_img_5.jpg"
                            icon={
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    data-name="Layer 1"
                        ...
                        <ServiceBox
                            index="6"
                            imagePath="service_thumbnail_img_6.jpg"
                            icon={
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    data-name="Layer 1"
                        ...
                        <ServiceBox
                            index="7"
                            imagePath="service_thumbnail_img_7.jpg"
                            icon={
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    data-name="Layer 1"
                        ...
                        <ServiceBox
                            index="8"
                            imagePath="service_thumbnail_img_8.jpg"
                            icon={
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    data-name="Layer 1"
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-9">
                                <h2 className="heading heading-very-large dark-1">
