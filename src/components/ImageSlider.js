                    ...
                    <div className="swiper-wrapper">
                        <SwiperSlide>
                            <div className="single-image">
                                <img
                                    src={`assets/images/${props.image1}`}
                                    alt="project_detailed_img1"
                                />
                            </div>
                        </SwiperSlide>
