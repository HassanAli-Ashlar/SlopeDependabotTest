                ...
                <div className="col-lg-12">
                    <div className="tabs">
                        <div className="text-list tabs-list text-list-large">
                            <h4
                                className={`heading tab-heading heading-small ${
                                    props.dark ? 'light-2' : 'dark-2'
                                }`}
                            >
                                APPROACH
                            </h4>
                        ...
                        <div className="tabs-content tab-content">
                            <div
                                className="tab-single show active tab-pane fade"
                                role="tabpanel"
                            >
                                <h4
                                    className={`heading heading-small ${
                                        props.dark ? 'light-2' : 'dark-2'
                                    }`}
                                >
